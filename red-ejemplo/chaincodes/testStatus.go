...
// InitLedger añade una lista de activos Asset para arrancar el ejemplo
   func (s *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
    assets := []Asset{
      {ID: "asset1", Color: "blue", Size: 5, Owner: "Tomoko", AppraisedValue: 300, Estado: "Nuevo"},
      {ID: "asset2", Color: "red", Size: 5, Owner: "Brad", AppraisedValue: 400, Estado: "Nuevo"},
      {ID: "asset3", Color: "green", Size: 10, Owner: "Jin Soo", AppraisedValue: 500, Estado: "Nuevo"},
      {ID: "asset4", Color: "yellow", Size: 10, Owner: "Max", AppraisedValue: 600, Estado: "Nuevo"},
      {ID: "asset5", Color: "black", Size: 15, Owner: "Adriana", AppraisedValue: 700, Estado: "Nuevo"},
      {ID: "asset6", Color: "white", Size: 15, Owner: "Michel", AppraisedValue: 800, Estado: "Nuevo"},
    }
...
// CreateAsset genera un nuevo Asset con los siguientes detalles
   func (s *SmartContract) CreateAsset(ctx contractapi.TransactionContextInterface, id string, color string, size int, owner string, appraisedValue int, estado string) error {
